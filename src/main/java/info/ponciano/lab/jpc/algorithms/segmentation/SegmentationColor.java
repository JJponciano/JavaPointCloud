...
public class SegmentationColor extends Segmentation {

    public SegmentationColor(APointCloud region, double distance) {
        super(region, distance);
    }

    public SegmentationColor(Voxel next) {
        super(next);
    }

    @Override
    protected Region createsRegion(APointCloud points, double distance) {
        return new RegionColor(points, distance);
    }
}
