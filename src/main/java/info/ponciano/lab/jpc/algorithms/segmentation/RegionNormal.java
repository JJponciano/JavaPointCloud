 ...
 */
public class RegionNormal extends RegionEuclidean {
     ...
     * contiguous.
     */
    public RegionNormal(final APointCloud points, double distance) {
...
//        return normalD <= this.normalDistance;
        Color c1 = this.getMeanNormal().toColor().asHumanPerception(ACCURACY);
        Color c2 = reg2.getMeanNormal().toColor().asHumanPerception(ACCURACY);
        return c1.equals(c2);
    }
