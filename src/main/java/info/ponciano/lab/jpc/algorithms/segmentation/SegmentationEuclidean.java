...
public class SegmentationEuclidean extends Segmentation {

    public SegmentationEuclidean(APointCloud region, double distance) {
        super(region, distance);
    }

    public SegmentationEuclidean(Voxel next) {
        super(next);
    }
