...
public class ScalePCTest {
    ...
    /**
     * Test of run method, of class ScalePC.
     */
    @Test
    public void testRun() {
        ...
        ScalePC instance = new ScalePC(pc,0.1f,10,1);
        instance.run();
        PointCloud cloud = instance.getCloud();
        PointColor get = cloud.get(0);
        PointColor get1 = cloud.get(1);
        PointColor get2 = cloud.get(2);
        assertEquals(get, new PointColor(1, 100, 10));
        assertEquals(get1, new PointColor(10, 80, 10));
        assertEquals(get2, new PointColor(1, 100, 100));
    }
